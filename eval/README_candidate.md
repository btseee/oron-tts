...
- name: oron-tts
  ...
  - task:
    ...
    metrics:
    - type: cer
      value: 0.07076144467448815
      name: CER, male voice
    - type: cer
      value: 0.059121233034276514
      name: CER, female voice
    - type: utmos
      value: 2.2632008108827804
      name: UTMOS, male voice
    - type: utmos
      value: 2.4242407431205115
...
Measured on the `voices/` prompts a caller actually gets, over held-out
sentences never used to select anything: n=360 per voice. Micro-CER and
mean UTMOS, with 95% bootstrap intervals.

| | male | female |
| --- | --- | --- |
| CER | 0.0708 [0.0659–0.0753] | 0.0591 [0.0551–0.0634] |
| UTMOS | 2.26 [2.24–2.29] | 2.42 [2.40–2.45] |
| speaker similarity to own prompt | 0.725 | 0.808 |

The voices score 0.103 against each other; real same-speaker pairs
here score 0.540–0.833, different speakers
0.034–0.503.
